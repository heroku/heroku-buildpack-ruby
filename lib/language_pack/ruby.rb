...
class LanguagePack::Ruby < LanguagePack::Base
  ...
  def initialize(arch:, app_path:, bundler:, cache_path:, environment_name:, gemfile_lock:, new_app:, ruby_version:, warn_io:)
    super(arch: arch, app_path: app_path, bundler: bundler, cache_path: cache_path, environment_name: environment_name, gemfile_lock: gemfile_lock, new_app: new_app, ruby_version: ruby_version, warn_io: warn_io)
